...
#define FMTOPT  "0:rtcm2,1:rtcm3,2:oem4,3:oem3,4:ubx,5:ss2,6:hemis,7:skytraq,8:gw10,9:javad,10:nvs,11:binex,12:rt17,13:dgr4,14:sbf,15:cmr,16:tersus,19:sp3"
...
static void prstream(vt_t *vt)
{
    ...
    const char *fmt[]={"rtcm2","rtcm3","oem4","oem3","ubx","ss2","hemis","skytreq",
                       "gw10","javad","nvs","binex","rt17","dgr4","sbf","cmr","","sp3",""};
