...
typedef struct {        /* imu type */
	...
	__declspec(dllexport) int _stdcall _input_dgrx_4(raw_t *raw, unsigned char data);
	__declspec(dllexport) int _stdcall _input_dgrx_9(raw_t *raw, unsigned char data);
	__declspec(dllexport) int _stdcall _input_dgrx_4f(raw_t *raw, FILE *fp);
	__declspec(dllexport) int _stdcall _input_dgrx_9f(raw_t *raw, FILE *fp);
