...
public:
	...
	private:
		...
		static_assert(sizeof(DGrX::FirmwareSchematicVersion::Data) == 19, "FirmwareSchematicVersion size is wrong");
	...
	private:
		...
		static_assert(sizeof(DGrX::RawMeasurementData::Data) == 37, "MeasuredPosition size is wrong");
	...
	public:
		...
		double L1Phase() {
			...
			for (auto i = 0; i < data.l1_phase.size(); ++i)
		...
		double L2Phase() {
			std::int64_t phase_int = 0;
			for (auto i = 0; i < data.l2_phase.size(); ++i)
	...
	private:
		struct Data {
			...
			std::uint32_t l5e5g3_pseudorange;
		} data;
		static_assert(sizeof(DGrX::L5E5G3MeasurementData::Data) == 15, "L5E5G3MeasurementData size is wrong");
	...
	public:
		...
		double L5E5G3Phase() {
			std::int64_t phase_int = 0;
			for (auto i = 0; i < data.l5e5g3_phase.size(); ++i)
	...
	private:
		...
		static_assert(sizeof(DGrX::MeasuredPositionData::Data) == 41, "MeasuredPositionData size is wrong");
	...
	private:
		...
		static_assert(sizeof(DGrX::GPSEphemerisData::Data) == 79, "GPSEphemerisData size is wrong");
	...
	private:
		...
		static_assert(sizeof(DGrX::GalileoEphemerisData::Data) == 79, "GalileoEphemerisData size is wrong");
	...
	private:
		...
		static_assert(sizeof(DGrX::GLONASSEphemerisData::Data) == 63, "GLONASSEphemerisData size is wrong");
	...
	private:
		...
		static_assert(sizeof(DGrX::RAIMAlertLimit::Data) == 5, "RAIMAlertLimit size is wrong");
	...
	private:
		...
		static_assert(sizeof(DGrX::CommandAcknowledgement::Data) == 1, "CommandAcknowledgement size is wrong");
	public:
	...
	private:
		...
		static_assert(sizeof(DGrX::CommandNAcknowledgement::Data) == 1, "CommandNAcknowledgement size is wrong");
	public:
	...
	private:
		...
		static_assert(sizeof(DGrX::LLAOutputMessage::Data) == 17, "LLAOutputMessage size is wrong");
	...
	private:
		...
		static_assert(sizeof(DGrX::ExcludedSV::Data) == 3, "ExcludedSV size is wrong");
	public:
		ExcludedSV() = default;
		template <typename T>
		ExcludedSV(T &file) {
	...
	private:
		...
		static_assert(sizeof(DGrX::ClockStatus::Data) == 31, "ClockStatus size is wrong");
	...
	private:
		...
		static_assert(sizeof(DGrX::GPSAlmanacData::Data) == 35, "GPSAlmanacData size is wrong");
	...
	private:
		...
		static_assert(sizeof(DGrX::GlonassAlmanacData::Data) == 29, "GlonassAlmanacData size is wrong");
	...
	private:
		...
		static_assert(sizeof(DGrX::RinexHeaderInformation::Data) == 189, "RinexHeaderInformation size is wrong");
	...
	public:
		...
		double AntennaDeltaH() {
			...
			for (auto i = 0; i < data.antenna_delta_h.size(); ++i)
		...
		double AntennaDeltaE() {
			...
			for (auto i = 0; i < data.antenna_delta_e.size(); ++i)
		...
		double AntennaDeltaN() {
			...
			for (auto i = 0; i < data.antenna_delta_n.size(); ++i)
...
private:
	bool Sync(std::ifstream &log_file) {
